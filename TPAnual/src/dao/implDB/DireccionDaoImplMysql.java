...
//Statements	
	...
	//Realizo la conexión	
		Connection conexion = null;
		 ...
		 try {
			...
			//Obtengo los datos y creo el objeto dirección	 
			...
			//Agrego la dirección a la lista	 
				 lista.add(direccion);
		    }
	...
	//Realizo la conexión	
		...
		//Seteo el parámetro    
			...
			//Obtengo los datos de la dirección y creo el objeto	
	...
	//Realizo la conexión	
		...
		try {	 
			...
			//Obtengo los datos y creo un objeto dirección	
